...
function paintGrain(ctx, size, seed, base, amp) {
...
function makeBrushedMetal(seed) {
...
export class WeaponViewmodel {
    ...
    inspect() {
        if (this.inspectT > 0 || this.reloadT > 0)
            return;
     ...
     */
    update(deltaTime, pose, lookDelta) {
...
//# sourceMappingURL=WeaponViewmodel.js.map
...
export class TAAResolveEffect {
    ...
    height = 0;
    frameIndex = 0;
    currentJitter = new THREE.Vector2();
    constructor(config) {
    ...
    nextFrame() {
        this.frameIndex++;
        this.currentJitter.set((halton(this.frameIndex, 2) - 0.5) * this.config.jitterScale, (halton(this.frameIndex, 3) - 0.5) * this.config.jitterScale);
    }
    /**
     * Apply jitter to a projection matrix
     */
    applyJitterToProjection(projection) {
...
//# sourceMappingURL=TAAResolveEffect.js.map
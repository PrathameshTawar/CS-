...
export class BloomEffect {
    ...
    render(input, output, _camera) {
        ...
        for (let i = 0; i < this.config.stages - 1; i++) {
            ...
            this.blurMaterial.uniforms.direction.value.set(1.0 / this.mipChain[i].width, 0.0);
            ...
            this.blurMaterial.uniforms.direction.value.set(0.0, 1.0 / this.mipChain[i + 1].height);

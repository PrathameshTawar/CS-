...
export class CreatorUI {
  ...
  private busDisposer: (() => void) | null = null;
  ...
  mount(container: HTMLElement): void {
    ...
    const form = this.el.querySelector('#creatorForm') as HTMLFormElement;
    ...
    this.busDisposer = this.bus.on<CreatorMutation[]>('creator.log.update', (mutations) => {

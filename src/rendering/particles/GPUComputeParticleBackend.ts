...
export class GPUComputeParticleBackend {
  ...
  private readonly posLife: Float32Array;
  private readonly velMaxLife: Float32Array;
  private readonly params: Float32Array; // [gravity, drag, bounce, kind]
  private readonly colorGlow: Float32Array;
  private readonly sizeArr: Float32Array;

  private readonly posLifeAttr: THREE.BufferAttribute;
  private readonly colorGlowAttr: THREE.BufferAttribute;

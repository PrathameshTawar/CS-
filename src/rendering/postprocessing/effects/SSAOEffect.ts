 ...
 */
export class SSAOEffect implements IPostEffect {
  readonly name = 'SSAO';
  ...
  private readonly ssaoRenderTarget: THREE.WebGLRenderTarget;
  private readonly blurRenderTarget: THREE.WebGLRenderTarget;

...
export class RenderPipeline {
  ...
  // Subsystems
  private readonly hdr: HDRPipeline;
  private readonly lighting: LightingSystem;
  private readonly csm: CascadedShadowMap;
  private readonly post: PostProcessingPipeline;

  // Effects
  private readonly taa: TAAResolveEffect;
  ...
  private readonly ldrTarget: THREE.WebGLRenderTarget;
  ...
  private _previousViewProjection: THREE.Matrix4 = new THREE.Matrix4();

  // Scratch VP matrix — reused every frame to avoid GC pressure
  private readonly _currentViewProjection: THREE.Matrix4 = new THREE.Matrix4();

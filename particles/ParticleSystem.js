...
export var ParticleKind;
(function (ParticleKind) {
    ParticleKind[ParticleKind["Smoke"] = 0] = "Smoke";
    ParticleKind[ParticleKind["Spark"] = 1] = "Spark";
    ParticleKind[ParticleKind["Blood"] = 2] = "Blood";
    ParticleKind[ParticleKind["Dust"] = 3] = "Dust";
    ParticleKind[ParticleKind["Shell"] = 4] = "Shell";
    ParticleKind[ParticleKind["Energy"] = 5] = "Energy";
    ParticleKind[ParticleKind["Wind"] = 6] = "Wind";
    ParticleKind[ParticleKind["Fire"] = 7] = "Fire";
    ParticleKind[ParticleKind["Rain"] = 8] = "Rain";
    /** Destruction debris — small tumbling fragments (Requirement 4.2). */
    ParticleKind[ParticleKind["Debris"] = 9] = "Debris";
...
export class ParticleSystem {
    ...
    sizeAttr = new Float32Array(MAX_PARTICLES);
    lifeAttr = new Float32Array(MAX_PARTICLES);
    kindAttr = new Float32Array(MAX_PARTICLES);
    gpuBackend;
    activeCount = 0;
    constructor(scene) {
        this.scene = scene;
     ...
     */
    emitMuzzleFlash(x, y, z, dirX, dirY, dirZ) {
        this.emit({
    ...
    emitShellCasing(x, y, z, dirX, dirZ) {
        this.emit({
    ...
    emitImpact(x, y, z, nx, ny, nz, surface) {
    ...
    emitBlood(x, y, z, dirX, dirY, dirZ) {
        this.emit({
     ...
     */
    emitDebris(x, y, z, nx, ny, nz, material, count = 12) {
        const colorMap = {
    ...
    emitSmoke(x, y, z, count = 10) {
        this.emitSmokeCloud(x, y, z, 1.2, count);
    }
    emitSmokeCloud(x, y, z, radius, count = 40) {
        for (let i = 0; i < count; i++) {

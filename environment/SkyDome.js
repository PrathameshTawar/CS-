...
export class SkyDome {
    mesh;
    material;
    sunDir = new THREE.Vector3(0.6, 0.8, 0.3).normalize();
    time = 0;
    constructor(scene) {
     ...
     */
    setAtmosphere(atmo) {
        this.material.uniforms.uZenith.value.setHex(atmo.zenith);
        this.material.uniforms.uHorizon.value.setHex(atmo.horizon);
        this.material.uniforms.uSunColor.value.setHex(atmo.sunColor);
        this.material.uniforms.uSunIntensity.value = atmo.sunIntensity;
        this.material.uniforms.uStarIntensity.value = atmo.starIntensity;
        this.material.uniforms.uCloudCover.value = atmo.cloudCover;

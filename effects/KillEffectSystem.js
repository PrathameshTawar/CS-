...
import { ParticleKind } from '../particles/ParticleSystem';
/**
 * Creates a high-contrast AAA sci-fi skull / kill confirmation icon canvas texture.
 */
function createKillBadgeTexture(headshot) {
...
export class KillEffectSystem {
    ...
    normalTex;
    headshotTex;
    constructor(scene, particles, shake, hud) {
        this.scene = scene;
...
//# sourceMappingURL=KillEffectSystem.js.map